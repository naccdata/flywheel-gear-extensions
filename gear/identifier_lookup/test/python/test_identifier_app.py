...
def identifiers_map():
    ...
    id_map = {}
    id_map["1"] = IdentifierObject(
        naccid="NACC000001", adcid=1, ptid="1", guid=None, naccadc=1111
    )
    id_map["2"] = IdentifierObject(
        naccid="NACC000002", adcid=1, ptid="2", guid=None, naccadc=2222
    )
    yield id_map
...
def mismatched_identifiers_map():
    ...
    id_map = {}
    id_map["3"] = IdentifierObject(
        naccid="NACC000001", adcid=1, ptid="3", guid=None, naccadc=3333
    )
    id_map["4"] = IdentifierObject(
        naccid="NACC000002", adcid=1, ptid="4", guid=None, naccadc=4444
    )
    yield id_map
...
class TestIdentifierLookup:
    ...
    def test_empty_input_stream(
        self, empty_data_stream: StringIO, identifiers_map: dict[Any, Any]
    ):
    ...
    def test_no_header(
        self, no_header_stream: StringIO, identifiers_map: dict[Any, Any]
    ):
    ...
    def test_no_id_column_headers(
        self, no_ids_stream: StringIO, identifiers_map: dict[Any, Any]
    ):
    ...
    def test_data_with_matching_ids(
    ...
    def test_data_with_mismatched_ids(
        self, data_stream: StringIO, mismatched_identifiers_map: dict[Any, Any]
    ):
