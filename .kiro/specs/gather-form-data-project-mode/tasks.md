...
- [x] 1. Implement project mode core (manifest, config model, orchestration function)
  - [x] 1.1 Update gear manifest for project mode support
  ...
  - [x] 1.2 Create ProjectModeConfig Pydantic model in main.py
  ...
  - [x] 1.3 Implement `run_project_mode` function in main.py
...
- [x] 2. Implement ProjectModeVisitor and entry point wiring
  - [x] 2.1 Implement `ProjectModeVisitor` class in run.py
  ...
  - [x] 2.2 Implement `ProjectModeVisitor.run` method
  ...
  - [x] 2.3 Update `main()` entry point in run.py for mode dispatch
  ...
  - [x] 2.4 Validate input_file requirement in participant_list mode
  ...
  - [x] 2.5 Implement output file writing for project mode
...
- [x] 3. Write tests
  - [x] 3.1 Write property test for resilience of run_project_mode
    - **Property 4: All subjects processed with resilience**
    - **Validates: Requirements 4.2, 5.1, 5.3, 5.4, 8.2**

  - [x] 3.2 Write integration tests for project mode end-to-end
  ...
  - [x] 3.3 Write backward compatibility tests for participant_list mode
