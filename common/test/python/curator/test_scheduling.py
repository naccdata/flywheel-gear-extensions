...
def fm(filename: str,
       ...
       scandt: Optional[date] = None) -> FileModel:
...
class TestFileModel:
    ...
    def test_visit_pass(self):
        ...
        assert fm("NACCXXX_NCRAD-SAMPLES-BRAIN-2008-06-20.json"
                  ).visit_pass == 'pass1'
        assert fm("NACCXXX_NCRAD-SAMPLES-BRAIN-TISSUE-2008-06-20.json"
                  ).visit_pass == 'pass1'
        assert fm("NACCXXX_NCRAD-SAMPLES-BLOOD-2008-06-20.json"
                  ).visit_pass == 'pass1'
        assert fm("NACCXXX_NCRAD-SAMPLES-PLASMA-2008-06-20.json"
                  ).visit_pass == 'pass1'
        assert fm(
            "NACCXXX_NCRAD-SAMPLES-DNA-2008-06-20.json").visit_pass == 'pass1'
        ...
        assert fm("NACCXXX-SCAN-AMYLOID-PET-GAAIN-2024-08-06.json"
                  ).visit_pass == 'pass1'
        assert fm("NACCXXX-SCAN-AMYLOID-PET-NPDKA-2024-08-06.json"
                  ).visit_pass == 'pass1'
        assert fm(
            "NACCXXX-SCAN-FDG-PET-NPDKA-2024-08-10.json").visit_pass == 'pass1'
        assert fm(
            "NACCXXX-SCAN-TAU-PET-NPDKA-2024-08-27.json").visit_pass == 'pass1'
