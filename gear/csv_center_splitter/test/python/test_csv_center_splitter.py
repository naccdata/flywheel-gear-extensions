...
def error_writer():
    ...
    return ListErrorWriter(container_id="dummmy-container", fw_path="dummy-fw-path")
...
def visitor(error_writer):
    ...
    visitor = CSVVisitorCenterSplitter(
        adcid_key="adcid", include={"0", "1", "2"}, error_writer=error_writer
    )
...
def merged_csv_data():
    ...
    return [
        ...
        {"adcid": "9", "data": "not-included", "extra": ""},
    ]
